...
const getSlotTimeDataListSlice = createSlice({
  name: "getSlotTimeDataList",
  initialState,
  extraReducers: (builder) => {
    // ----------------------------------------------------
    builder.addCase(getSlotTimeDataList.pending, (state) => {
      state.loading = true;
    });
    builder.addCase(
      getSlotTimeDataList.fulfilled,
      (state, action) => {
        state.loading = false;
...
export default getSlotTimeDataListSlice.reducer;
