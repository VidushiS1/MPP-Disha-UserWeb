...
import StadyTree from "../../assets/under-graduation.gif";
...
import {addUnderGraduationDiplomaData} from "../../../rtk/features/RegistrationForm/addUnderGraduationDiplomaDataSlice"
...
const UnderGraduationDiplomaForm = () => {
  ...
  const handleChange = (e) => {
    ...
    if (name === "school_name_10th" || name === "school_name_12th" || name === "institute_ug_dp") {
...
if (name === "course_ug_dp") {
  ...
  if (!alphabeticPattern.test(value)) {
    ...
    if (name === "parcentage_10th" || name === "parcentage_12th" || name === "parcentage_ug_dp") {
 ...
 const handleFileInputChange = (event) => {
  ...
  useEffect(() => {
    setclassUgdpInfoForm((prevFormValue) => ({
      ...
      passing_year_ug_dp: selectedDateUgdp?.format(dateFormat),
      achivement_ug_dp:fileNameUgdp,
    }));
...
useEffect(()=>{
  if(isFieldDisabled){
    ...
    setclassUgdpInfoForm({
      ...
      passing_year_ug_dp:"",
      parcentage_ug_dp:"",
      pursuing_ug_dp:isFieldDisabled
    })
  }
  else if(classUgdpInfoForm?.parcentage_ug_dp || classUgdpInfoForm?.passing_year_ug_dp ){
    setclassUgdpInfoForm({
      ...classUgdpInfoForm,
      pursuing_ug_dp:false
    })
  }

},[isFieldDisabled,classUgdpInfoForm?.parcentage_ug_dp,classUgdpInfoForm?.passing_year_ug_dp])


const requiredField = ["student_id","education_mode_10th","education_medium_10th","board_10th","school_name_10th","education_mode_12th","education_medium_12th","board_12th","school_name_12th","institute_ug_dp","course_ug_dp","education_medium_ug_dp","education_mode_ug_dp","parcentage_10th","parcentage_12th"];
...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    if (classUgdpInfoForm?.passing_year_10th === "Invalid Date" || classUgdpInfoForm?.passing_year_12th === "Invalid Date") {
      toast.error("Select year of passing for both 10th and 12th", {
        toastId: customId,
      });
      return;
    }

    if (classUgdpInfoForm?.parcentage_10th === "00" || classUgdpInfoForm?.parcentage_12th === "00" ) {
      toast.error("Please fill the percentage field for both 10th and 12th class", {
        toastId: customId,
      });
      return;
    }

    if (classUgdpInfoForm?.pursuing_ug_dp === false && classUgdpInfoForm?.passing_year_ug_dp === "Invalid Date") {
      toast.error("Please Select the year of passing for Ug diploma.", {
        toastId: customId,
      });
      return;
    }

    if (classUgdpInfoForm?.pursuing_ug_dp === false && (classUgdpInfoForm?.parcentage_ug_dp === "" || classUgdpInfoForm?.parcentage_ug_dp === "00")) {
      toast.error("Please fill the percentage field in Ug diploma", {
        toastId: customId,
      });
      return;
    }
    ...
    const actionResult = await dispatch(addUnderGraduationDiplomaData(formData));
              ...
              <div className="login-form-layout-main ">
                <div className="flex justify-between items-center">
                  ...
                  <h1
                    ...
                    style={{ color: "#264796" }}
                  >
                    Fill Form For Class 10th, 12th and UG Diploma
                  </h1>
                    ...
                    <>
                      ...
                      <div className="mb-3 w-full flex justify-between items-center">
                        <div className="flex flex-col">
                          ...
                          <TextField
                            sx={{ width: "228px" }}
                            name="institute_ug_dp"
                            value={classUgdpInfoForm.institute_ug_dp}
                            onChange={handleChange}
                        ...
                        <div className="flex flex-col">
                          ...
                          <TextField
                            sx={{ width: "228px" }}
                            name="course_ug_dp"
                            value={classUgdpInfoForm.course_ug_dp}
                            onChange={handleChange}
                      ...
                      <div className="mb-3 w-full flex justify-between items-center">
                        <div className="flex flex-col">
                          ...
                          <RadioGroup
                            row
                            aria-labelledby="demo-row-radio-buttons-group-label"
                            name="education_medium_ug_dp"
                          value={classUgdpInfoForm.education_medium_ug_dp}
                          onChange={handleChange}
                          >
                            <FormControlLabel
                              value="english"
                      ...
                      <div className="mb-3 w-full flex justify-between items-center">
                        ...
                        <div className="flex flex-col">
                          ...
                          <TextField
                            sx={{ width: "220px" }}
                            name="parcentage_ug_dp"
                            value={classUgdpInfoForm.parcentage_ug_dp}
                            onChange={handleChange}
                            placeholder="Please Enter Percentage %"
                            disabled={isFieldDisabled}
                          />
                      ...
                      <div className="mb-3 w-full flex justify-between items-center">
                        <div className="flex flex-col">
                          ...
                          <RadioGroup
                            row
                            aria-labelledby="demo-row-radio-buttons-group-label"
                            name="education_mode_ug_dp"
                            value={classUgdpInfoForm.education_mode_ug_dp}
                            onChange={handleChange}
                          >
                            <FormControlLabel
                              value="regular"
...
export default UnderGraduationDiplomaForm;
